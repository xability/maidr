...
import { ScatterPlotExample } from './examples/ScatterPlotExample';
...
const examples: { name: string; component: () => JSX.Element }[] = [
  ...
  { name: 'Grouped Bar', component: GroupedBarExample },
  ...
  { name: 'Scatter Plot', component: ScatterPlotExample },
  { name: 'Pie Chart', component: PieChartExample },
  { name: 'Donut Chart', component: DonutChartExample },
  { name: 'Heatmap', component: HeatmapExample },
