...
describe('Bar Plot', () => {
  ...
  it('should be able to move from left to right', () => {
    helper.verifyLeftToRightMovement(maidrData, TestConstants.BAR_ID);
  });

  it('should be able to move from right to left', () => {
    helper.verifyRightToLeftMovement(maidrData, TestConstants.BAR_ID);
  });
  ...
  it('Autoplay - left to right', () => {
    helper.verifyAutoplay(maidrData, TestConstants.BAR_ID, TestConstants.FORWARD);
  });

  it('Autoplay - right to left', () => {
    helper.verifyAutoplay(maidrData, TestConstants.BAR_ID, TestConstants.BACKWARD);
  });
});
