...
class KeyBinding {
    ...
    createCommand(key) {
        switch (key) {
            case Keymap.MOVE_UP: return new command_1.MoveUpCommand(this.plot);
            case Keymap.MOVE_DOWN: return new command_1.MoveDownCommand(this.plot);
            case Keymap.MOVE_RIGHT: return new command_1.MoveRightCommand(this.plot);
            case Keymap.MOVE_LEFT: return new command_1.MoveLeftCommand(this.plot);
            case Keymap.TOGGLE_SOUND: return new command_1.ToggleSoundCommand(this.audio);
            case Keymap.TOGGLE_TEXT: return new command_1.ToggleTextCommand(this.display);
