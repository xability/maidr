...
export const model = {
  ...
  'model.statOperatingPointsPerCurve': 'Operating points per curve',
  'model.statAreaUnderCurve': 'Area under the curve',
  'model.statHighestArea': 'Highest area under the curve',
  'model.statCurvesBelowChance': 'Curves below chance',
  'model.statBestOperatingPoint': 'Best operating point',
  'model.rocOperatingPoint': '{x} {fpr}, {y} {tpr}',
  'model.rocOperatingPointAtThreshold': '{point}, at threshold {threshold}',
  'model.asideAboveChance': 'Above chance',
  'model.asideBelowChance': 'Below chance',
  'model.extremaBestOperatingPoint': 'Best operating point',
  'model.tableThreshold': 'Threshold',
  ...
  'model.rugObservationOf': '{index} of {count}',
  'model.statDensestInterval': 'Densest interval',
