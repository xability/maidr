...
export const model = {
  ...
  // layer does not name.
  'model.extremaMaxBarAt': 'Max Bar at {label}',
  'model.extremaMinBarAt': 'Min Bar at {label}',
  ...
  'model.extremaGlobalMaximum': 'Global Maximum: {value} at {x}, {y}',
  'model.extremaGlobalMinimum': 'Global Minimum: {value} at {x}, {y}',
  'model.extremaRowMaximum': 'Row Maximum: {value} at {x}, {y}',
  'model.extremaRowMinimum': 'Row Minimum: {value} at {x}, {y}',
  'model.extremaColumnMaximum': 'Column Maximum: {value} at {x}, {y}',
  'model.extremaColumnMinimum': 'Column Minimum: {value} at {x}, {y}',
  ...
  'model.extremaMaxPointAt': 'Max point at {label}',
  'model.extremaMinPointAt': 'Min point at {label}',
  ...
  'model.asideSum': 'Sum',
  'model.extremaMaxGroupAt': 'Max {group} at {category}',
  'model.extremaMinGroupAt': 'Min {group} at {category}',
  ...
  'model.extremaRankAt': '{rank} at {label}',
  ...
  'model.extremaMaxSectionAt': 'Max {section} at {where}',
  'model.extremaMinSectionAt': 'Min {section} at {where}',
  ...
  'model.extremaLargestIncreaseAt': 'Largest increase at {label}',
  'model.extremaLargestDecreaseAt': 'Largest decrease at {label}',
  // Word cloud.
  ...
  'model.extremaHeaviestTerm': 'Heaviest term, {term}',
  'model.extremaLightestTerm': 'Lightest term, {term}',
  ...
  'model.extremaMaxVolatilityAt': 'Max Volatility at {label}',
  'model.extremaMinVolatilityAt': 'Min Volatility at {label}',
  'model.extremaMaxSegmentAt': 'Max {segment} at {label}',
  'model.extremaMinSegmentAt': 'Min {segment} at {label}',
  ...
  'model.extremaMaxDeltaAt': 'Max Delta at {label}',
  'model.extremaMinDeltaAt': 'Min Delta at {label}',
} as const;
