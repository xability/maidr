...
export const keybinding = {
  ...
  'keybinding.helpRecordingPrompt': 'Press the new shortcut for {action}. Escape cancels; Backspace restores the default.',
  'keybinding.helpRecordingHint': 'Press keys…',
  'keybinding.helpRecordingCancelled': 'Shortcut unchanged.',
  'keybinding.helpRebound': '{action} is now {key}.',
  'keybinding.helpResetOne': '{action} restored to {key}.',
  'keybinding.helpResetButton': 'Restore default',
  'keybinding.helpResetShortcutFor': 'Restore the default shortcut for {action}',
  'keybinding.helpResetAllButton': 'Restore all default shortcuts',
  'keybinding.helpResetAllDone': 'All shortcuts restored to their defaults.',
  'keybinding.helpConflict': '{key} is already used by {other}.',
  'keybinding.helpUnsupportedKey': 'That key cannot be used as a shortcut.',
  'keybinding.helpCustomKey': '{key} (custom, default {defaultKey})',
