...
export default class KeyBinding {
    ...
    private createCommand(key: string): Command {
        switch (key) {
            case Keymap.MOVE_UP: return new MoveUpCommand(this.plot);
            case Keymap.MOVE_DOWN: return new MoveDownCommand(this.plot);
            case Keymap.MOVE_RIGHT: return new MoveRightCommand(this.plot);
            case Keymap.MOVE_LEFT: return new MoveLeftCommand(this.plot);

            case Keymap.TOGGLE_SOUND: return new ToggleSoundCommand(this.audio);
            case Keymap.TOGGLE_TEXT: return new ToggleTextCommand(this.display);
