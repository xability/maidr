...
export const TITLES = {
  ...
  'apexcharts-bar-horizontal.html': 'Horizontal Bar Chart',
  'apexcharts-box-horizontal.html': 'Horizontal Box Plot',
  'apexcharts-bubble.html': 'Bubble Chart',
  'apexcharts-donut.html': 'Donut Chart',
  'apexcharts-mixed.html': 'Mixed (Column + Line)',
  'apexcharts-normalized.html': '100% Stacked Bar Chart',
  'apexcharts-polar-area.html': 'Polar Area Chart',
  'apexcharts-stacked-area.html': 'Stacked Area Chart',
...
export const PAGE_TYPES = {
  ...
  'apexcharts-bar-horizontal.html': ['bar'],
  'apexcharts-box-horizontal.html': ['box'],
  'apexcharts-bubble.html': ['point'],
  'apexcharts-donut.html': ['pie'],
  'apexcharts-mixed.html': ['bar', 'line'],
  'apexcharts-polar-area.html': ['polar_area'],
  'apexcharts-stacked-area.html': ['stacked_area'],
...
export const GROUPS = [
  ...
  },
  {
    ...
    heading: 'ApexCharts',
    prefixes: ['apexcharts-'],
    headingPrefix: 'ApexCharts',
    note: 'See the <a href="apexcharts.html">ApexCharts Integration Guide</a> for setup instructions and code examples for all chart types.',
  },
  {
    id: 'tableau',
    heading: 'Tableau',
