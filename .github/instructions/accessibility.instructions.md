...
applyTo: "src/ui/**,src/service/audio.ts,src/service/audioPalette.ts,src/service/braille.ts,src/service/text.ts,src/service/description.ts,src/service/notification.ts,src/service/highlight.ts,src/service/highContrast.ts,src/service/keybinding.ts"
---

<!-- Generated from .claude/rules/accessibility.md by scripts/sync-copilot-instructions.mjs. Do not edit directly. -->
