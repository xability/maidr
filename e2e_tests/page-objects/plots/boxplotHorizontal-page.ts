...
export class BoxplotHorizontalPage extends BasePage {
   ...
   * @throws BoxplotHorizontalError if rotor navigation fails
   */
  public async moveToNextRotorMode(): Promise<void> {
    try {
      ...
      throw new BoxplotHorizontalError(`Failed to move to next rotor mode: ${errorMessage}`);
    }
  }
  ...
  public async moveToPrevRotorMode(): Promise<void> {
    try {
      ...
      const errorMessage = error instanceof Error ? error.message : String(error);
      throw new BoxplotHorizontalError(`Failed to move to previous rotor mode: ${errorMessage}`);
    }
  }
   ...
   * @throws BoxplotHorizontalError if mode cannot be retrieved
   */
  ...
  public async navigateToRotorMode(targetMode: string): Promise<void> {
    ...
    throw new BoxplotHorizontalError(`Failed to navigate to rotor mode: ${targetMode}`);
  }
   ...
   * @throws BoxplotHorizontalError if modal fails to open
   */
  public async openGoToExtremaModal(): Promise<void> {
    try {
      ...
      const errorMessage = error instanceof Error ? error.message : String(error);
      throw new BoxplotHorizontalError(`Failed to open Go To Extrema modal: ${errorMessage}`);
    }
  }
   ...
   * @throws BoxplotHorizontalError if modal fails to close
   */
  public async closeGoToExtremaModal(): Promise<void> {
    try {
      ...
      const errorMessage = error instanceof Error ? error.message : String(error);
      throw new BoxplotHorizontalError(`Failed to close Go To Extrema modal: ${errorMessage}`);
    }
  }
   ...
   * @throws BoxplotHorizontalError if selection fails
   */
  public async selectExtremaTarget(): Promise<void> {
    try {
      ...
      const errorMessage = error instanceof Error ? error.message : String(error);
      throw new BoxplotHorizontalError(`Failed to select extrema target: ${errorMessage}`);
    }
  }
   ...
   * @throws BoxplotHorizontalError if unable to get targets
   */
  public async getExtremaTargets(): Promise<string[]> {
    try {
      ...
      const errorMessage = error instanceof Error ? error.message : String(error);
      throw new BoxplotHorizontalError(`Failed to get extrema targets: ${errorMessage}`);
    }
  }
   ...
   * @throws BoxplotHorizontalError if unable to get selected target
   */
  public async getSelectedExtremaTarget(): Promise<string> {
    try {
      ...
      const errorMessage = error instanceof Error ? error.message : String(error);
      throw new BoxplotHorizontalError(`Failed to get selected extrema target: ${errorMessage}`);
    }
  }
  ...
  public async goToMaximum(): Promise<void> {
    try {
      ...
      const errorMessage = error instanceof Error ? error.message : String(error);
      throw new BoxplotHorizontalError(`Failed to navigate to maximum: ${errorMessage}`);
    }
  }
  ...
  public async goToMinimum(): Promise<void> {
    try {
      ...
      const errorMessage = error instanceof Error ? error.message : String(error);
      throw new BoxplotHorizontalError(`Failed to navigate to minimum: ${errorMessage}`);
    }
  }
}
