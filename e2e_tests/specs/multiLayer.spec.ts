...
test.describe('Multi Layer Plot', () => {
  ...
  test.describe('First Layer (Default)', () => {
    ...
    test('should not be able to move up', async ({ page }) => {
      ...
      await multiLayerPlotPage.moveToNextDataPoint(); // Remove once up arrow key is handled in Multi Layer plot
    ...
    test('should execute forward autoplay', async ({ page }) => {
      ...
      try {
        ...
        await multiLayerPlotPage.startForwardAutoplay(
          expectedDataPoint,
        );
      } catch (error) {
        const errorMessage = error instanceof Error ? error.message : String(error);
    ...
    test('should execute reverse autoplay', async ({ page }) => {
      ...
      try {
        ...
        await multiLayerPlotPage.startReverseAutoplay(
          expectedDataPoint,
        );
      } catch (error) {
        const errorMessage = error instanceof Error ? error.message : String(error);
  ...
  test.describe('Switching to Other Layer', () => {
  ...
  test.describe('Switching to Bottom Layer', () => {
