...
export class BoxplotHorizontalPage extends BasePage {
  ...
  protected readonly selectors = {
    ...
    svg: `svg#${TestConstants.BOXPLOT_HORIZONTAL_ID}`,
  ...
  public async navigateToBoxplotHorizontal(): Promise<void> {
    try {
      ...
      throw new BoxplotHorizontalError(`Failed to navigate to Boxplot Horizontal. ${error}`);
    }
  }
  ...
  public async activateMaidr(): Promise<void> {
    try {
      ...
      throw new BoxplotHorizontalError(`Failed to activate MAIDR. ${error}`);
    }
  }
  ...
  public async activateMaidrOnClick(): Promise<void> {
    try {
      ...
      throw new BoxplotHorizontalError(`Failed to activate MAIDR by clicking. ${error}`);
    }
  }
  ...
  public async getInstructionText(): Promise<string> {
    try {
      ...
      throw new BoxplotHorizontalError(`Failed to get instruction text. ${error}`);
    }
  }
  ...
  public async isTextModeActive(textMode: string): Promise<boolean> {
    try {
      ...
      throw new BoxplotHorizontalError(`Failed to check text mode status. ${error}`);
    }
  }
  ...
  public async isBrailleModeActive(brailleMode: string): Promise<boolean> {
    try {
      ...
      throw new BoxplotHorizontalError(`Failed to check braille mode status. ${error}`);
    }
  }
  ...
  public async isSonificationActive(sonificationMode: string): Promise<boolean> {
    try {
      ...
      throw new BoxplotHorizontalError(`Failed to check sonification mode status. ${error}`);
    }
  }
  ...
  public async isReviewModeActive(reviewMode: string): Promise<boolean> {
    try {
      ...
      throw new BoxplotHorizontalError(`Failed to check review mode status. ${error}`);
    }
  }
  ...
  public async getXAxisTitle(): Promise<string> {
    try {
      ...
      throw new BoxplotHorizontalError(`Failed to get X-axis title. ${error}`);
    }
  }
  ...
  public async getYAxisTitle(): Promise<string> {
    try {
      ...
      throw new BoxplotHorizontalError(`Failed to get Y-axis title. ${error}`);
    }
  }
  ...
  public async getPlaybackSpeed(): Promise<number> {
    try {
      ...
      throw new BoxplotHorizontalError(`Failed to get playback speed. ${error}`);
    }
  }
  ...
  public async getCurrentDataPointInfo(): Promise<string> {
    try {
      ...
      throw new BoxplotHorizontalError(`Failed to get current data point information. ${error}`);
    }
  }
  ...
  public async getSpeedToggleInfo(): Promise<string> {
    try {
      ...
      throw new BoxplotHorizontalError(`Failed to get speed toggle information. ${error}`);
    }
  }
  ...
  public async startForwardAutoplay(
    ...
    try {
      ...
      throw new BoxplotHorizontalError(`Failed to start forward autoplay. ${error}`);
    }
  }
  ...
  public async startReverseAutoplay(
    ...
    try {
      ...
      throw new BoxplotHorizontalError(`Failed to start reverse autoplay. ${error}`);
    }
  }
  ...
  public async startDownwardAutoplay(
    ...
    try {
      ...
      throw new BoxplotHorizontalError(`Failed to start downward autoplay. ${error}`);
    }
  }
  ...
  public async startUpwardAutoplay(
    ...
    try {
      ...
      throw new BoxplotHorizontalError(`Failed to start upward autoplay. ${error}`);
    }
  }
  ...
  public async verifyPlotLoaded(): Promise<void> {
    try {
      ...
      throw new BoxplotHorizontalError(`Boxplot Horizontal failed to load correctly. ${error}`);
    }
  }
}
